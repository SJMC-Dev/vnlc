...
VnlcToken::VnlcToken(VnlcTokenType type, std::string_view value, unsigned int line, unsigned int column, unsigned int offset)
    : type(type),
      value(value),
      offset(offset),
      line(line),
...
VnlcToken& VnlcToken::operator=(VnlcToken&& other) noexcept {
    if (this != &other) {
        type = other.type;
...
VnlcToken& VnlcToken::operator=(const VnlcToken& other) {
    if (this != &other) {
        type = other.type;
        value = other.value;
        offset = other.offset;
